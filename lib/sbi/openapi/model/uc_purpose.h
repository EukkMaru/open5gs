...
typedef enum { OpenAPI_uc_purpose_NULL = 0, OpenAPI_uc_purpose_ANALYTICS, OpenAPI_uc_purpose_MODEL_TRAINING, OpenAPI_uc_purpose_NW_CAP_EXPOSURE, OpenAPI_uc_purpose_EDGEAPP_UE_LOCATION, OpenAPI_uc_purpose_ENERGY } OpenAPI_uc_purpose_e;
