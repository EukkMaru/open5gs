...
#include "nssai_1.h"
#include "odb_exempted_dnn_info_1.h"
...
#include "time_sync_data_1.h"
#include "trace_data.h"
#include "ue_level_measurements_configuration_1.h"
...
struct OpenAPI_access_and_mobility_subscription_data_1_s {
    ...
    char *chf_group_id;
    struct OpenAPI_time_sync_data_1_s *time_sync_data;
    OpenAPI_list_t *shared_data_list;
    struct OpenAPI_qmc_config_info_1_s *qmc_config_info;
    struct OpenAPI_mbsr_operation_allowed_1_s *mbsr_operation_allowed;
    bool is_ncr_operation_allowed;
    int ncr_operation_allowed;
    OpenAPI_list_t* ladn_service_areas;
    struct OpenAPI_ue_level_measurements_configuration_1_s *ue_level_measurements_configuration;
...
OpenAPI_access_and_mobility_subscription_data_1_t *OpenAPI_access_and_mobility_subscription_data_1_create(
    ...
    char *_3gpp_charging_characteristics,
    char *chf_group_id,
    OpenAPI_time_sync_data_1_t *time_sync_data,
    OpenAPI_list_t *shared_data_list,
    OpenAPI_qmc_config_info_1_t *qmc_config_info,
    OpenAPI_mbsr_operation_allowed_1_t *mbsr_operation_allowed,
    bool is_ncr_operation_allowed,
    int ncr_operation_allowed,
    OpenAPI_list_t* ladn_service_areas,
    OpenAPI_ue_level_measurements_configuration_1_t *ue_level_measurements_configuration,
    OpenAPI_list_t *allowed_rats,
    bool is_am_policy_ind,
    int am_policy_ind,
    bool is_ue_policy_ind,
