...
typedef enum { OpenAPI_net_loc_access_support_NULL = 0, OpenAPI_net_loc_access_support_ANR_NOT_SUPPORTED, OpenAPI_net_loc_access_support_TZR_NOT_SUPPORTED, OpenAPI_net_loc_access_support_LOC_NOT_SUPPORTED, OpenAPI_net_loc_access_support_UE_SAT_NOT_SUPPORTED } OpenAPI_net_loc_access_support_e;
