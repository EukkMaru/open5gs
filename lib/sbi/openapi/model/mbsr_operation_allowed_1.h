/*
 * mbsr_operation_allowed_1.h
 *
 * Indicates whether the UE is allowed for MBSR operation
 */

#ifndef _OpenAPI_mbsr_operation_allowed_1_H_
#define _OpenAPI_mbsr_operation_allowed_1_H_
...
typedef struct OpenAPI_mbsr_operation_allowed_1_s OpenAPI_mbsr_operation_allowed_1_t;
...
struct OpenAPI_mbsr_operation_allowed_1_s {
    bool is_mbsr_operation_allowed_ind;
    int mbsr_operation_allowed_ind;
    struct OpenAPI_mbsr_location_info_1_s *mbsr_location_info;
...
#endif /* _OpenAPI_mbsr_operation_allowed_1_H_ */
