...
#ifndef _OpenAPI_wlan_per_ue_id_performance_info_H_
#define _OpenAPI_wlan_per_ue_id_performance_info_H_
...
typedef struct OpenAPI_wlan_per_ue_id_performance_info_s OpenAPI_wlan_per_ue_id_performance_info_t;
...
struct OpenAPI_wlan_per_ue_id_performance_info_s {
    char *supi;
    char *gpsi;
...
#endif /* _OpenAPI_wlan_per_ue_id_performance_info_H_ */
