/*
 * ranging_sl_lcs_client_external.h
 *
 * Describes list of Call/session Unrelated Class for ranging and sidelink  positioningidentified by LCS client in the external LCS client list. 
 */

#ifndef _OpenAPI_ranging_sl_lcs_client_external_H_
#define _OpenAPI_ranging_sl_lcs_client_external_H_
...
typedef struct OpenAPI_ranging_sl_lcs_client_external_s OpenAPI_ranging_sl_lcs_client_external_t;
...
struct OpenAPI_ranging_sl_lcs_client_external_s {
...
#endif /* _OpenAPI_ranging_sl_lcs_client_external_H_ */
