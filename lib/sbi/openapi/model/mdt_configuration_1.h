...
struct OpenAPI_mdt_configuration_1_s {
    ...
    struct OpenAPI_area_scope_1_s *area_scope;
    ...
    struct OpenAPI_bluetooth_measurement_1_s *bluetooth_measurement_nr;
    struct OpenAPI_bluetooth_measurement_1_s *bluetooth_measurement_lte;
    struct OpenAPI_wlan_measurement_1_s *wlan_measurement_nr;
    struct OpenAPI_wlan_measurement_1_s *wlan_measurement_lte;
...
OpenAPI_mdt_configuration_1_t *OpenAPI_mdt_configuration_1_create(
    OpenAPI_job_type_e job_type,
    OpenAPI_report_type_mdt_e report_type,
    OpenAPI_area_scope_1_t *area_scope,
    OpenAPI_list_t *measurement_lte_list,
    OpenAPI_list_t *measurement_nr_list,
    OpenAPI_list_t *sensor_measurement_list,
    OpenAPI_list_t *sensor_measurement_lte_list,
    ...
    bool is_event_threshold_sinr_nr,
    int event_threshold_sinr_nr,
    OpenAPI_bluetooth_measurement_1_t *bluetooth_measurement_nr,
    OpenAPI_bluetooth_measurement_1_t *bluetooth_measurement_lte,
    OpenAPI_wlan_measurement_1_t *wlan_measurement_nr,
    OpenAPI_wlan_measurement_1_t *wlan_measurement_lte,
    OpenAPI_list_t *slice_area_scope
);
